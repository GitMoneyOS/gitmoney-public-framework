...
```mermaid
flowchart LR
    A["Private Notebook<br/>Source memory and unfinished thinking"] -->|"bounded brief"| B["Work Desk<br/>Human and agent drafts"]
    B -->|"owner review and approval"| C["Company Record<br/>Versioned assets and receipts"]
    C -->|"measured learning"| A
```
