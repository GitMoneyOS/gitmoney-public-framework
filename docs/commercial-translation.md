...
- the founder is still middleware;
- AI output is outrunning review;
- sales, delivery, or operations logic is hard to hand off;
- important assets cannot be traced to an owner or approval path;
